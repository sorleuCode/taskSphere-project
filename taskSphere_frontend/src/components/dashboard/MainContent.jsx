    ...
    return (
        <div className="flex-1 p-6 bg-gray-50">
            ...
            <div className="flex flex-wrap">
                <div className="bg-gradient-to-r from-pink-500 to-purple-500 text-white p-4 rounded-lg shadow-md transform transition duration-500 hover:scale-105">
                    <h2 className="text-lg font-bold">My Design</h2>
                </div>
            </div>
        </div>
    );
