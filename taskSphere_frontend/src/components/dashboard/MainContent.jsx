...
const MainContent = () => {
    ...
    const [showBocards, setShowBoards] = useState(true);
    ...
    return (
        <div className="flex-1 p-6 overflow-y-auto bg-white text-black">
            ...
            {!showForm ? (
                <button onClick={() => handleCreateBoardClick()} className="bg-gray-200 text-gray-700 py-2 px-4 rounded-lg mb-6 flex items-center">
...

            {
                showBocards && <div>
                    ...
                    <div className="mb-6">
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex gap-3 items-center">
                                ...
                                <div className='z-0 relative flex items-center bg-white border outline-none border-gray-300 rounded p-2'>
                    ...
                    <div className="flex flex-wrap">
                        <Link to="/board"><div className="bg-gradient-to-r from-pink-500 to-purple-500 text-white p-4 rounded-lg">
